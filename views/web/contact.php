...
<html lang="pt-BR">
  ...
  <body>
    <main>
      <section class="hero">
        <div class="container">
          <h1 class="color-alter">Entre em Contato</h1>
      ...
      <section class="faq-teaser">
        <div class="container">
          ...
          <a href="/FillTime/faqs" class="btn-outline">Ver Perguntas Frequentes</a>
        </div>
      </section>
    </main>
    ...
    <script>
      document.getElementById('contactForm').addEventListener('submit', async function(e) {
        ...
        try {
          const response = await fetch('/FillTime/api/contact.php', {
            method: 'POST',
            headers: {
