...
/**
 * Classe HttpCourt - Extensão de HttpClientBase para operações de quadras
 * Implementa conceitos de Orientação a Objetos com herança
 */
export class HttpCourt extends HttpClientBase {
    ...
    async createCourt(courtData) {
        try {
            ...
            // Se for uma instância de Court, converte para FormData
